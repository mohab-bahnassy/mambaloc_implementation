    ...
    def __init__(
        ...
        **kwargs, # Absorb kwarg for general module
        ...
        self.in_proj = nn.Linear(
            ...
            bias=bias,
            **clean_factory_kwargs,  # Use clean_factory_kwargs
        )
        self.z_bias = (
            nn.Parameter(torch.zeros(self.d_inner, **clean_factory_kwargs)) if not bias else 0
        ...
        # D "skip" parameter
        self.D = nn.Parameter(torch.ones(self.n_v_heads, **clean_factory_kwargs))
        self.D._optim = {"weight_decay": 0.0}

        # out_proj
        self.out_proj = nn.Linear(
            self.d_inner, self.d_model, bias=bias, **clean_factory_kwargs  # Use clean_factory_kwargs
        )
